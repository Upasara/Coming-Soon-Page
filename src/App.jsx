...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    // Send email to your address using mailto:
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-100 text-center px-4">
      {/* Logo / top section */}
      <div className="bg-white shadow-md rounded-full px-6 py-2 mb-8">
        <span className="font-semibold text-gray-700">YourBrand</span>
      </div>

      {/* Content */}
      <div className="max-w-2xl bg-white/60 backdrop-blur-md rounded-3xl p-10 shadow-lg">
      ...
      <p className="text-gray-400 text-sm mt-6">© 2025 YourBrand. All rights reserved.</p>
    </div>
  );
}
